...
<html>
	...
	<body>
		<div id="content" role="main" class="container-lg" align="center">
			<div class="row">
				<div class="col-lg-12">
					<br><p class="h3" href="/Teams">Create a new team</p><br>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<form method="post" action="Teams">
						<table>
							<tr>
								<td><label for="nameTeam">Team Name:</label></td>
								<td><input type="text" name="nameTeam" id="nameTeam"></td><br>
							</tr>
							<tr>
